...
namespace DLLBrandMaster
{
    ...
    public class BAL_BrandMaster
    {
        public static void InsertBrand(PL_BrandMaster pobj)
        {
            pobj.Opcode = 11;
            DAL_Login.ReturnTable(pobj);
        }
        public static void BindBrandList(PL_BrandMaster pobj)
        {
            pobj.Opcode = 42;
            DAL_Login.ReturnTable(pobj);
        }
        public static void DeleteBrand(PL_BrandMaster pobj)
        {
            pobj.Opcode = 21;
            DAL_Login.ReturnTable(pobj);
        }
        ...
        public static void UpdateBrand(PL_BrandMaster pobj)
        {
            pobj.Opcode = 31;
            DAL_Login.ReturnTable(pobj);
        }
