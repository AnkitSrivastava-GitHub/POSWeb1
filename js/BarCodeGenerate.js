 ...
 */
function DrawCode39Barcode1(data, checkDigit) {

    return DrawHTMLBarcode_Code39(data, checkDigit, "yes", "in", 0, 2, 0.5, 2, "bottom", "center", "", "black", "white");
}
...
function DrawBarcode_Code39(data,
    ...
    if (mode == "html") {
        ...
        if (humanReadable == 'yes' && textLocation == 'top') {
            if (textStyle == '')
                humanSpan = '<span style="font-family : arial; font-size:10pt">' + humanReadableText + '</span><br />';
            else
    ...
    if (mode == "html") {
        ...
        if (humanReadable == 'yes' && textLocation == 'bottom') {
            if (textStyle == '')
                humanSpan = '<br /><span style="font-family : arial; font-size:10pt">' + humanReadableText + '</span>';
            else
