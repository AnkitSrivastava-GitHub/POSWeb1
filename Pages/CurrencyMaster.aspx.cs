...
public partial class Pages_CurrencyMaster : System.Web.UI.Page
{
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        {
            string text = File.ReadAllText(Server.MapPath("/Pages/CustomJS/CurrencyMaster.js"));
    ...
    public static string InsertCurrency(string dataValue)
    {
        ...
        global::DLLCurrencyMaster.PL_CurrencyMaster pobj = new global::DLLCurrencyMaster.PL_CurrencyMaster();
        try
        {
            if (System.Web.HttpContext.Current.Session["EmpAutoId"] != null)
            {
                ...
                global::DLLCurrencyMaster.BAL_CurrencyMaster.InsertCurrency(pobj);
    ...
    public static string BindCurrencyList(string dataValue)
    {
        ...
        try
        {
            if (System.Web.HttpContext.Current.Session["EmpAutoId"] != null)
            {
                ...
                pobj.Who = Convert.ToInt32(HttpContext.Current.Session["EmpAutoId"]);
                pobj.StoreId = Convert.ToInt32(HttpContext.Current.Session["StoreId"]);
                global::DLLCurrencyMaster.BAL_CurrencyMaster.BindCurrencyList(pobj);
                if (pobj.isException != true)
                {
                    return pobj.Ds.GetXml();
                    //return "true";
    ...
    public static string DeleteCurrency(string dataValue)
    {
        ...
        try
        {
            if (System.Web.HttpContext.Current.Session["EmpAutoId"] != null)
            {
                ...
                pobj.Who = Convert.ToInt32(HttpContext.Current.Session["EmpAutoId"]);
                global::DLLCurrencyMaster.BAL_CurrencyMaster.DeleteCurrency(pobj);
                if (pobj.isException != true)
                {
                    //return pobj.Ds.GetXml();
                    return "true";
    ...
    public static string editCurrency(string dataValue)
    {
        ...
        try
        {
            if (System.Web.HttpContext.Current.Session["EmpAutoId"] != null)
            {
                pobj.CurrencyAutoId = Convert.ToInt32(jdv["CurrencyAutoId"]);
                pobj.Who = Convert.ToInt32(HttpContext.Current.Session["EmpAutoId"]);
                global::DLLCurrencyMaster.BAL_CurrencyMaster.editCurrency(pobj);
                if (pobj.isException != true)
                {
                    return pobj.Ds.GetXml();
                    //return "true";
    ...
    public static string UpdateCurrency(string dataValue)
    {
        ...
        try
        {
            if (System.Web.HttpContext.Current.Session["EmpAutoId"] != null)
            {
                ...
                pobj.Who = Convert.ToInt32(HttpContext.Current.Session["EmpAutoId"]);
                pobj.StoreId = Convert.ToInt32(HttpContext.Current.Session["StoreId"]);
                global::DLLCurrencyMaster.BAL_CurrencyMaster.UpdateCurrency(pobj);
                if (pobj.isException != true)
                {
                    //return pobj.Ds.GetXml();
                    return "true";
