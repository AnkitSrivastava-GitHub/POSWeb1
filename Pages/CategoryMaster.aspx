<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeFile="CategoryMaster.aspx.cs" Inherits="Pages_CategoryMaster" %>
                ...
                <div class="panel panel-default">
                    ...
                    <div class="panel-body">
                        <div class="row" style="margin-bottom: 10px;">
                            ...
                            <div class="col-md-4">
                                <input type="text" id="txtSCategoryName" maxlength="60" onkeypress="return /[0-9a-zA-Z ]/i.test(event.key)" class="form-control input-sm" placeholder="Category Name" />
                            </div>
                            ...
                            <div class="col-md-2">
                                <button id="btnSearch" type="button" onclick="BindCategoryList(1);" class="btn btn-sm catsearch-btn pull-right">Search</button>
                            </div>
                        </div>
                        <div class="form-group"></div>
                        <div class="table-responsive">
                            <table id="tblCategoryList" class="table table-striped table-bordered well" style="margin-bottom: 0px;">
                                <thead>
                                    <tr class="thead">
                                        <td class="Action" style="width: 50px;">Action</td>
                                        <td class="CategoryAutoId" style="display: none;">CategoryAutoId</td>
        ...
        <div class="modal-dialog modal-dialog-centered actionb-p" role="document">
            <div class="modal-content card-p">
                <div class="modal-header cardm-head Deposit">
                    <h5 class="modal-title">Category Details 
                ...
                <div class="modal-body" style="padding: 15px 0 0 0;">
                    <div class="row">
                        ...
                        <div class="col-md-8 form-group">
                            <input type="text" id="txtCategoryName" maxlength="60" onkeypress="return /[0-9a-zA-Z ]/i.test(event.key)" class="form-control input-sm" placeholder="Enter Category Name" />
                        </div>
                    </div>
                    <div class="row">
                        <label class="col-md-4 form-group">
                    ...
                    <div class="row">
                        <div class="col-md-12 form-group">
                            <div class="pull-right">
                                <button type="button" id="btnSave" onclick="InsertCategory();" class="btn btn-sm catsave-btn">Save</button>
                                <button type="button" id="btnUpdate" onclick="UpdateCategory();" class="btn btn-sm catsave-btn" style="display: none">Update</button>
