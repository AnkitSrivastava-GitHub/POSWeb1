...
public partial class Pages_LogInLogDetail : System.Web.UI.Page
{
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        {
            string text = File.ReadAllText(Server.MapPath("/Pages/CustomJS/LogInUserList.js"));
    ...
    public static string BindUser()
    {
        ...
        try
        {
            ...
            {
                BAL_LogInUserdetail.BindUser(pobj);
    ...
    public static string BindUserList(string dataValue)
    {
        ...
        try
        {
            if (System.Web.HttpContext.Current.Session["EmpAutoId"] != null)
            {
                ...
                BAL_LogInUserdetail.BindUserList(pobj);
                if (pobj.isException != true)
                {
                    return pobj.Ds.GetXml();
                    //return "true";
