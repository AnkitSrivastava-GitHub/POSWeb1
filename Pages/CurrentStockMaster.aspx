<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeFile="CurrentStockMaster.aspx.cs" Inherits="Pages_CurrentStockMaster" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    ...
    <section class="content-header">
        <h1>Product Purchase History
          <%-- <a href="/Pages/DirectInvoiceGenerate.aspx" class="btn btn-sm btn-warning pull-right">Add New Sale Invoice</a>--%>
        </h1>
    </section>
                    ...
                    <div class="panel-body">
                        <div class="row">
                            <div class="col-md-3 form-group">
                                <input type="text" id="txtInvoiceNumber" class="form-control input-sm" placeholder="Enter Invoice Number" />
                            </div>
                            <div class="col-md-3 form-group">
                                <input type="text" id="txtPONumber" class="form-control input-sm" placeholder="Enter PO Number" />
                            </div>
                            <div class="col-md-3 form-group">
                            ...
                            <div class="col-md-1 form-group" style="text-align: right;">
                                <button type="button" id="btnSearchInvoice" onclick="BindCurrentStockList(1);" class="btn btn-sm catsearch-btn">Search</button>
                            </div>
                        </div>
                        ...
                        <div class="form-group row" style="padding-bottom: 0px; margin-bottom: 0px; margin-top: 10px;" id="DivPager">
                            <div class="col-md-1">
                                <select class="form-control border-primary input-sm" style="width: 100px" id="ddlPageSize" onchange="BindCurrentStockList(1)">
                        ...
                        <table id="tblInvoiceProductList" class="table table-striped table-bordered well" style="margin-bottom: 0px;">
                            <thead>
                                <tr class="thead">
                                    ...
                                    <td class="SellingUnitCost" style="white-space: nowrap; text-align: center">Selling Unit Price($)</td>
                                    <td class="SecondaryCost" style="white-space: nowrap; text-align: center">Secondary Unit Price($)</td>
                                    <td class="PreviousCost" style="white-space: nowrap; text-align: center">Previous Cost Price($)</td>
                                    <td class="SUnitPrice" style="white-space: nowrap; text-align: center">Cost Price($)</td>
                                    <td class="Tax" style="white-space: nowrap; text-align: center">Tax ($)</td>
                                    <td class="Total" style="white-space: nowrap; text-align: center">Total ($)</td>
                                </tr>
                            </thead>
                        </table>
            ...
            <div class="modal-content">
                <div class="modal-header">
                    <h4 class="modal-title"><strong>Stock Details</strong>
                        <img src="../Images/del.png" class="del-btn close" data-dismiss="modal" id="CloseModalPS" />
                    </h4>
                </div>
                        ...
                        <table id="tblPreviousStockList" class="table table-striped table-bordered well" style="margin-bottom: 0px;">
                            <thead>
                                <tr class="thead">
                                    ...
                                    <td class="EffectedStock" style="white-space: nowrap; text-align: center">Effected Stock QTY</td>
                                </tr>
                            </thead>
                        </table>
