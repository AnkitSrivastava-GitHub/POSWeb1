<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeFile="ExpenseMaster.aspx.cs" Inherits="Pages_ExpenseMaster" %>
            ...
            <div class="panel panel-default">
                ...
                <div class="panel-body">
                    <div class="row" style="margin-bottom: 10px;">
                        <div class="col-md-6">
                            <input type="text" id="txtExpenseName" maxlength="100" class="form-control input-sm" placeholder="Expense Name" />
                        </div>
                        <div class="col-md-4">
                        ...
                        <div class="col-md-2">
                            <button id="btnSearch" type="button" onclick="BindExpenseList(1);" class="btn btn-sm catsearch-btn pull-right">Search</button>
                        </div>
                    </div>
                        ...
                        <table id="tblExpenseList" class="table table-striped table-bordered well" style="margin-bottom: 0px;display:none;">
                            <thead>
                                <tr class="thead">
                                    ...
                                    <td class="ExpenseAutoId" style="display: none;">ExpenseAutoId</td>
                                    <td class="ExpenseName" style="white-space: nowrap; text-align: center;">Expense Name</td>
                    ...
                    <div class="form-group row" style="padding-bottom: 0px; margin-bottom: 0px; margin-top: 10px;" id="DivPager">
                        <div class="col-md-2">
                            <select class="form-control border-primary input-sm" id="ddlPageSize" style="display:none;" onchange="BindExpenseList(1)">
        ...
        <div class="modal-dialog modal-dialog-centered actionb-p" role="document">
            <div class="modal-content card-p">
                <div class="modal-header cardm-head Deposit">
                    <h5 class="modal-title">Expense Details
                ...
                <div class="modal-body" style="padding: 15px 0 0 0;">
                    <div class="row">
                        ...
                        <div class="col-md-8 form-group">
                            <input type="text"  maxlength="100" id="txtExpensesName" class="form-control input-sm" placeholder="Enter Expense Name" />
                        </div>
                    </div>
                    ...
                    <div class="row">
                        <div class="col-md-12 form-group">
                            <div class="pull-right">
                                <button type="button" id="btnSave" onclick="InsertExpense();" class="btn btn-sm catsave-btn">Save</button>
                                <button type="button" id="btnUpdate" onclick="UpdateExpense();" class="btn btn-sm catsave-btn" style="display: none">Update</button>
